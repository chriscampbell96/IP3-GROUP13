  ...
  <body>
    ...
    <nav class="navbar navbar-toggleable-md fixed-top" style="background-color:#F3F4F5">
          ...
          <a class="navbar-brand">
            <img src="img/logo.jpg" height="40" width="180">
          </a>
  ...
  <div class="container-signin">
    <div class="background">
      <form class="form-signin">
        ...
        <a href="home.php" class="btn btn-lg btn-primary btn-block" type="submit" style="background-color: #0A3245; border: 1px solid #0A3245;"> Test Pages </a>
      </form>
    </div> <!--/background-->
    </div> <!-- /container -->
